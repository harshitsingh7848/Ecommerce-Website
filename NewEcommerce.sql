...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 15, 2018 at 02:14 PM
...
INSERT INTO `orders` (`id`, `order_quantity`, `order_date`, `mode_of_payment`) VALUES
...
INSERT INTO `store_address` (`id`, `address`, `address_type`, `user_id`, `Pincode`, `city`, `state`, `mobile_number`, `name`) VALUES
(1, 'dahhchkshcshk', 2, 2, 224001, 'ssggc', 'dffhsdh', '', ''),
(2, 'cclcsccskkk', 1, 3, 224001, 'Bhopal', 'Madhya Pradesh', '7073351942', 'Vipul Gupta'),
(3, 'abxbxbaxb', 2, 3, 302026, 'Jaipur', 'Rajasthan', '7073351942', 'Vipul Gupta');
