...
console.log(data.A);
        ...
        /* for (var prop in product) {
          ...
          /* if(localStorage.getItem('products')){   
            var productInfo = localStorage.getItem('products');
            var productsDetail = JSON.parse(productInfo);
            alert(JSON.stringify(product));
            for (var prop in productsDetail) {
            console.log( prop + ': ' + productsDetail[prop]);
        }
