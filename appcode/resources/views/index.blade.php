                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                           ...
                           @if (!empty($name))
                           Hello {{  $name }}
                             <li><a href="{{ url('/') }}"><i class="fa fa-user"></i>Logout</a></li>
                            @else
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="{{ url('cart') }}">Cart - <span class="cart-amunt">$100</span> <i class="fa fa-shopping-cart"></i> <span class="product-count">5</span></a>
                    </div>
                </div>
            </div>
        </div>
